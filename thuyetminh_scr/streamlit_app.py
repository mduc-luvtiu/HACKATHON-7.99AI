            ...
            with video_tab1:
                if latest_video["original_path"]:
                    ...
                    if video_bytes:
                        ...
                        st.info(
                            f"📁 Đường dẫn: {latest_video['original_path']}")
                        st.info(
                            f"📅 Tạo lúc: {latest_video['created_time'][:19]}")
                    else:
            ...
            with video_tab2:
                if latest_video.get("transformed_path"):
                    ...
                    if video_bytes:
                        ...
                        st.info(
                            f"📁 Đường dẫn: {latest_video['transformed_path']}")
                    ...
                    st.info(
                        "⏳ Video chưa được thuyết minh. Vui lòng chờ hoặc thử lại!")
                    st.info(
